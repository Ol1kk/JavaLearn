...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (exit == 0) {
            ...
            System.out.println("Введите <5> чтобы показать товары, отсортированные по производителю");
            ...
            if (command.equals("1")) {
                ...
                phoneStore.getPhones(vendorSearchInput, modelSearchInput);
